...
[backlog] **F**: CLI Surface ([F_cli-surface.md](./F_cli-surface.md))
    ...
    └── [backlog] **F8**: Unified update: lock-tracked skills + actionable output ([F8_unified-update-lock-tracked-skills-actionable-output.md](./F8_unified-update-lock-tracked-skills-actionable-output.md))
