...
updated_at: "2026-07-17T06:14:58.053Z"
---
...
**Sharp question.** How should mapPluginToRulesync + install dispatch stage plugins/<plugin>/scripts to .rulesync/scripts/<plugin>/ and copy to ~/.agents/scripts/<plugin>/ (and project twin) for non-native targets while Claude/OMP/Grok keep native plugin scripts/?
