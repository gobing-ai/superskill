/**
 * Parity tests for terminal escape sanitization (CWE-150 fix) in
 * skills-ecosystem/sanitize.ts.
 *
 * Fixtures ported verbatim from vercel-labs/skills
 * (vendors/skills/tests/sanitize-terminal.test.ts) — same inputs, same
...
import { sanitizeMetadata, stripTerminalEscapes } from '../../src/skills-ecosystem/sanitize';
