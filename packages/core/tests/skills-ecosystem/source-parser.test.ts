/**
 * Parity tests for skills-ecosystem/source-parser.ts.
 *
 * Fixtures ported verbatim from vercel-labs/skills
 * (vendors/skills/tests/source-parser.test.ts) — same inputs, same expected
 * outputs; only the test-runner import (vitest → bun:test) and module paths
 * changed.
 *
...
import { getOwnerRepo, parseSource } from '../../src/skills-ecosystem/source-parser';
