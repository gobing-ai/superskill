/**
 * Parity tests for sanitizeName in skills-ecosystem/sanitize.ts.
 *
 * Fixtures ported verbatim from vercel-labs/skills
 * (vendors/skills/tests/sanitize-name.test.ts) — same inputs, same expected
 * outputs; only the test-runner import (vitest → bun:test) and module path
 * changed.
 *
