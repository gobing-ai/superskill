#!/usr/bin/env node
// @bun
// PORTABLE TWIN — generated from validate_response.ts by `bun run build:scripts`. Do not edit by
// hand; re-run the generator when validate_response.ts or ah_guard.ts changes. ESM `.mjs` so Node
// runs it anywhere (no `type:module` package.json required on the target). Entrypoint Contract v1.
...
export { main, readStdinText, validateResponseText };
