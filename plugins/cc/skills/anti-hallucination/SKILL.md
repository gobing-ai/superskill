...
The guard engine at `plugins/cc/scripts/anti-hallucination/ah_guard.ts` provides Stop hook integration for automated protocol enforcement. See `references/guard-implementation.md` for integration details.
